            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Data Keanggotaan</h6>
                 ...
                 <p>Selamat Datang <strong><?php echo $user; ?></strong> calon Anggota PMII Kab. Banjar. Untuk bergabung menjadi anggota kami diperlukan beberapa langkah yaitu pengisian formulir data pribadi, test tertulis dan test wawancara.</p>
                  ...
                  <div class="col-md-6"> 
                   <div class="text-center">
                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 18rem;" src="img/blog/blog-image-2.jpg" alt="">
                  </div>
                  </div>
                  <div class="col-md-6">
                   <div class="text-center  mt-5 mb-4">
                    <a href="permohonan" class="btn btn-success btn-icon-split "  >
                      ...
                      <span class="text">Input Permohonan Keanggotaan</span>
                    </a>
                  </div>
                  </div>
                  </div>
